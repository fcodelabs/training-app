                    ...
                    children: [
                      ...
                      BlocBuilder<DiaryHomeBloc, DiaryHomeState>(
                        buildWhen: (previous, current) =>
                            current.isInputVisible != previous.isInputVisible,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      if (textFieldController.text.isEmpty ||
                                        ...
                                        diaryHomeBloc.add(SubmitDataEvent(
                                            textFieldValueTitle:
                      ...
                      BlocBuilder<DiaryHomeBloc, DiaryHomeState>(
                        buildWhen: (previous, current) =>
                            current.diaryEntries != previous.diaryEntries,
                        builder: (context, state) {
